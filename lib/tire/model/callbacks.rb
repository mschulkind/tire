    ...
    module Callbacks
      ...
      def self.included(base)
        ...
        if base.respond_to?(:after_save) && base.respond_to?(:after_destroy)
          base.send :after_save,    lambda { tire.update_index if Tire::Configuration.callbacks_enabled}
          base.send :after_destroy, lambda { tire.update_index if Tire::Configuration.callbacks_enabled}
        end
